...
This version marks a significant stabilisation of the backup utility, addressing fundamental architectural limitations found in v3.5. It should HOPEFULLY be a lot more stable and work as intended. I have been working on this version for quite some time, but ran into a lot of difficulties getting it stable so kept it back. I need to give the Restore Archive a bit of love, but it’s working fine for me now with a few quirks. i changed to zstd it's just better.
